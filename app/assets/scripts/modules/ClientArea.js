...
class ClientArea {
    constructor() {
        ...
        this.contentArea = document.querySelector('.client-area_content-area');
        this.events();
    }
    ...
    sendRequest() {
        Axios.post('https://vibrant-jackson-3b9cc4.netlify.app/.netlify/functions/secret-area', { password: this.field.value })
            ...
            .catch(() => {
                this.contentArea.innerHTML = `<p class="client-are__error">That secret phrase is not correct. Try again.</p>`;
                this.field.value = '';
                this.field.focus();
            });
    }
